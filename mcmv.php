...
<head>
    ...
    <title>ENGETEG | Minha Casa Minha Vida</title>
    <link rel="stylesheet" href="assets/css/mcmv.css">
</head>
<body>

    <?php include_once("header.php")?>

    <section style="background-image: url(assets/img/mcmv.png)">
        <div class="sobre">
            <h2>Mais fácil que mudar de endereço!</h2>
            <div class="line-horizontal"></div>
            <p>Dúvidas sobre o programa Minha Casa, Minha Vida? Aqui você confere mais informções sobre essa opção de financiamento imobiliário. Acesse e veja como ficou fácil conquistar o sonho da casa própria com a Engeteg!</p>
            <p>
